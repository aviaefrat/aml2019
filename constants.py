...
LETTERS_UPPER = ABC_UPPER + ACCENTS_UPPER
LETTERS_LOWER = ABC_LOWER + ACCENTS_LOWER
...
HPARAM_GRID = ParameterGrid({'learning_rate': [0.05], 'num_leaves': [31]})
CONSTANT_HPARAMS = {'objective': 'multiclass', 'num_class': 8, 'metric': 'multi_logloss',
